...
*Hanya Admins:*
 ...
 ✪ /cleanwelcome <on/off>*:* Setiap ada anggota baru, Akan menghapus pesan selamat datang sebelumnya untuk menghindari spam chat. 
 ✪ /welcomemutehelp*:* memberikan informasi tentang penyambutan bisu.
 ✪ /cleanservice <on/off*:* menghapus pesan layanan selamat datang/keluar telegram.
 *Contoh:*
pengguna bergabung dengan obrolan, pengguna meninggalkan obrolan. 

*Welcome markdown:* 
 ✪ `/welcomehelp`*:* melihat lebih banyak informasi pemformatan untuk pesan selamat datang/selamat tinggal khusus.
"""
